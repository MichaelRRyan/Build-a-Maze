...
void Mathematician::setPos(int t_row, int t_col)
{
...
/// </summary>
/// <param name="t_maze"></param>
void Mathematician::checkForExit(int t_maze[][MAZE_COLS])
{
	// Check Vertically
...
/// <summary>
/// Animate the sprite to walk
/// </summary>
void Mathematician::animate()
{
...
/// </summary>
void Mathematician::setTextureDirection()
{
	switch (m_moveDir)
	{
...
sf::Vector2i Mathematician::getDirectionVector(Direction t_direction)
{
	switch (t_direction)
	{
	case Direction::None:
...
Direction Mathematician::getDirection(sf::Vector2i t_directionVec)
{
